...
class ExpiredTokenTest < ExpiredToken
  ...
  test "should direct to the password-reset page" do
    assert_redirected_to new_password_reset_url
  end

  test "should include the word 'expire' on the password-reset page" do
    follow_redirect!
    assert_match (/expired/i), response.body
  end

  # test "should check if user is logged in and the reset digest is cleared" do
  #   reset_user.reload
